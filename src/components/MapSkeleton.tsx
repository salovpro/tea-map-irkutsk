export function MapSkeleton() {
  return (
    <div className="fixed inset-0 z-0 w-full overflow-hidden bg-slate-100">
      <div
        className="absolute inset-x-0 top-0 overflow-hidden bg-gradient-to-br from-stone-100 via-slate-100 to-stone-200"
        style={{
          bottom:
      ...
      >
        ...
        <div className="tea-map-bottom-controls flex flex-col gap-3">
